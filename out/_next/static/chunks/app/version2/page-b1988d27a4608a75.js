(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[216],{8806:function(t,e,n){Promise.resolve().then(n.bind(n,9698))},6264:function(t,e,n){"use strict";n.d(e,{I:function(){return o},t:function(){return a}});let c="https://api.ibrahimlogs.me".replace(/\/$/,"");async function i(t,e){try{let n="".concat(c).concat(t);console.log("Fetching from:",n);let i=await fetch(n,{...e,headers:{Accept:"application/json","Content-Type":"application/json",...(null==e?void 0:e.headers)||{}},next:{revalidate:!1}});if(!i.ok){let n=await i.text().catch(()=>"");throw Error("".concat((null==e?void 0:e.method)||"GET"," ").concat(t," failed (").concat(i.status,"): ").concat(n))}if(204===i.status)return{};return await i.json()}catch(e){return console.warn("API call failed, using fallback data: ".concat(t),e),{data:{siteConfig:{site_name:"Portfolio",tagline:"Full-stack Developer",github_url:"#",linkedin_url:"#"},portfolioSettings:{active_version:"v1"},navItems:[],socialLinks:[],sections:{hero:[{settings:{},ctas:[]}],about:[{}],projects:[{}],skills:[{}],experience:[{}],contact:[{}],footer:[{}]},projects:[],experiences:[],skills:{categories:[],radars:[]},highlights:[],principles:[]}}}}async function a(){return i("/api/public/site-data")}async function o(t){return i("/api/public/contact",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}},3231:function(t,e,n){"use strict";n.d(e,{Z:function(){return c}});/**
